...
import { IMPORT_ROLE } from "constants/roles";
import jwt from "jsonwebtoken";
import { useSelector } from "react-redux";
import { Redirect, Route, useRouteMatch } from "react-router-dom";
import { toast } from "react-toastify";

function ProtectedImportRoute(props) {
    ...
    <Route
      ...
      render={(props) => {
        try {
          ...
          if (!(auth.data.roles.includes(IMPORT_ROLE) || auth.data.isAdmin)) {
...
export default ProtectedImportRoute;
